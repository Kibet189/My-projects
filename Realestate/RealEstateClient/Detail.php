    ...
    <div class= "panel panel-danger">
      <div class="panel-heading">
        <div class="panel-tittle">
          <h4><strong style="float: center; color: rgb(000); ;">DEVILLA MANSIONS AND PROPERTIES | ESTATE</strong></h4>
          <div class="panel-body"></div>
        </div>
      </div></div>
    </div>
    <h2 style="float: right;"><img class="img-circle img-responsive" width="130" height="130" src="../img/for.jpg"></h2>
  </div>
</div>
<div class="row">
	<div class="container">
    ...
    while( $row = $result->fetch_assoc()){ ?>
     <center><strong style="color: gold"><i><u><h3>Devilla Estate Featured image</h3></u></i></strong></center>
		...
		<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <center><strong style="color: gold"><i><u><h3>Devilla Estate Details</h3></u></i></strong></center>
