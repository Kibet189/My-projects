			...
			<div class="col-md-4">
				...
				<div class="col-sm-8 centered"  style="border-left: double;" id="ba">
                     ...
                     <ul class="breadcrumb pull-right">
                        <li><a href="#" class="btn btn-primary">Computers</a></li>
                        <li><a href="#" class="btn btn-warning">Network</a></li>
                        <li><a href="Get.php" class="btn btn-danger">Contact Us</a></button></li>
...
<form role="form" action="login.php" method="POST" novalidate>
